...
router.post('/dashboard/votenow', pollController.dashboardVoteNow,
  // (req: Request, res: Response) => {return res.status(200).send('This is the working database vote now button')}
);
...
router.patch('/updated-votes',pollController.updatedVotes
